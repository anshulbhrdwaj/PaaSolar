...
export function Navbar() {
  ...
  return (
    ...
    >
      ...
      {mobileOpen && (
        <div
          className="lg:hidden fixed inset-x-0 top-full h-[calc(100dvh-100%)] max-h-[calc(100dvh-100%)] bg-bg-primary/98 dark:bg-bg-primary/98 backdrop-blur-2xl border-b border-line px-4 py-5 sm:p-6 shadow-2xl animate-mobile-drawer overflow-y-auto overscroll-contain touch-pan-y z-50"
          style={{
          ...
          <div className="max-w-xl mx-auto w-full flex flex-col gap-3.5">
            ...
            <div className="grid grid-cols-2 gap-2.5 pb-1">
              <Link
                ...
                className="flex items-center justify-center gap-2 p-3 rounded-2xl bg-accent-solar/10 border border-accent-solar/30 text-accent-solar text-xs font-bold hover:bg-accent-solar/20 transition-all shadow-sm text-center"
              >
                <Calculator className="w-4 h-4 shrink-0" />
                <span className="truncate">Get Full Quote</span>
              </Link>
              <Link
                href="/export"
                onClick={() => setMobileOpen(false)}
                className="flex items-center justify-center gap-2 p-3 rounded-2xl bg-accent-sky/10 border border-accent-sky/30 text-accent-sky text-xs font-bold hover:bg-accent-sky/20 transition-all shadow-sm text-center"
              >
                <Globe2 className="w-4 h-4 shrink-0" />
                <span className="truncate">Global Exports</span>
              </Link>
            </div>
            ...
            >
              <div className="flex items-center gap-3">
                <Building2 className="w-4 h-4 text-accent-solar shrink-0" />
            ...
            <div className="rounded-2xl border border-line/80 bg-bg-secondary/40 overflow-hidden transition-all">
              ...
              >
                <div className="flex items-center gap-3">
                  <SunMedium className="w-4.5 h-4.5 text-accent-solar shrink-0" />
              ...
              {mobileProductsOpen && (
                <div className="p-3 flex flex-col gap-2.5 border-t border-line/60 bg-bg-primary/50 text-xs">
                  {/* Solar Panels */}
                  <div className="space-y-2 p-2.5 rounded-xl bg-bg-secondary/50 border border-line/40">
                    <Link
                      href="/products/solar-panels"
                      onClick={() => setMobileOpen(false)}
                      className="flex items-center justify-between font-bold text-text-primary hover:text-accent-solar text-xs py-0.5"
                    >
                      <div className="flex items-center gap-2">
                        <SunMedium className="w-3.5 h-3.5 text-accent-solar shrink-0" />
                        <span>{t('productsDropdown.solarPanels')}</span>
                      </div>
                      <ChevronRight className="w-3.5 h-3.5 text-text-secondary shrink-0" />
                    </Link>
                    <div className="grid grid-cols-2 gap-2 pl-5 pt-0.5">
                      <Link
                        href="/products/solar-panels#topcon"
                        onClick={() => setMobileOpen(false)}
                        className="px-2.5 py-1.5 rounded-lg bg-bg-primary border border-line text-[11px] font-semibold text-text-secondary hover:text-accent-solar text-center truncate"
                      >
                      ...
                      <Link
                        href="/products/solar-panels#dcr"
                        onClick={() => setMobileOpen(false)}
                        className="px-2.5 py-1.5 rounded-lg bg-bg-primary border border-line text-[11px] font-semibold text-text-secondary hover:text-emerald-500 text-center truncate"
                      >
                  ...
                  <div className="space-y-2 p-2.5 rounded-xl bg-bg-secondary/50 border border-line/40">
                    ...
                    >
                      <div className="flex items-center gap-2">
                        <Zap className="w-3.5 h-3.5 text-accent-sky shrink-0" />
                        <span>{t('productsDropdown.inverters')}</span>
                      </div>
                      <ChevronRight className="w-3.5 h-3.5 text-text-secondary shrink-0" />
                    </Link>
                    <div className="grid grid-cols-3 gap-1.5 pl-5 pt-0.5">
                      <Link
                        href="/products/inverters#ongrid"
                        onClick={() => setMobileOpen(false)}
                        className="px-1.5 py-1.5 text-center rounded-lg bg-bg-primary border border-line text-[11px] font-semibold text-text-secondary hover:text-accent-sky truncate"
                      >
                        On-Grid
                      </Link>
                      <Link
                        href="/products/inverters#offgrid"
                        onClick={() => setMobileOpen(false)}
                        className="px-1.5 py-1.5 text-center rounded-lg bg-bg-primary border border-line text-[11px] font-semibold text-text-secondary hover:text-accent-gold truncate"
                      >
                        Off-Grid
                      </Link>
                      <Link
                        href="/products/inverters#hybrid"
                        onClick={() => setMobileOpen(false)}
                        className="px-1.5 py-1.5 text-center rounded-lg bg-bg-primary border border-line text-[11px] font-semibold text-text-secondary hover:text-emerald-500 truncate"
                      >
                        Hybrid
                      </Link>
                    </div>
                  ...
                  <Link
                    href="/products/battery"
                    onClick={() => setMobileOpen(false)}
                    className="flex items-center justify-between p-2.5 rounded-xl bg-bg-secondary/50 border border-line/40 font-bold text-text-primary hover:text-accent-solar"
                  >
                    <div className="flex items-center gap-2.5">
                      <BatteryCharging className="w-4 h-4 text-accent-gold shrink-0" />
                  ...
                  <Link
                    href="/products/franchise-sgy"
                    onClick={() => setMobileOpen(false)}
                    className="flex items-center justify-between p-3 rounded-xl bg-emerald-500/10 border border-emerald-500/30 font-bold text-text-primary hover:text-emerald-500 gap-2"
                  >
                    <div className="flex items-center gap-2.5 min-w-0">
                      <Store className="w-4 h-4 text-emerald-500 shrink-0" />
                      <span className="text-xs leading-snug">Solar Kit & PM SGY Franchise (3-10kW)</span>
                    </div>
                  ...
                  <div className="flex items-center gap-2 pt-1">
                    <Link
                      href="/products"
                      onClick={() => setMobileOpen(false)}
                      className="flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-accent-solar/10 border border-accent-solar/30 text-accent-solar font-bold text-xs"
                    >
                    ...
                    <a
                      ...
                      rel="noopener noreferrer"
                      onClick={() => setMobileOpen(false)}
                      className="flex-1 flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-xl bg-accent-solar text-white font-bold text-xs shadow-sm"
                    >
            ...
            <div className="rounded-2xl border border-line/80 bg-bg-secondary/40 overflow-hidden transition-all">
              ...
              >
                <div className="flex items-center gap-3">
                  <Layers className="w-4.5 h-4.5 text-accent-sky shrink-0" />
              ...
              {mobileProjectsOpen && (
                <div className="p-3 grid grid-cols-1 sm:grid-cols-2 gap-2.5 border-t border-line/60 bg-bg-primary/50 text-xs">
                  <Link
                    href="/projects/ci"
                    onClick={() => setMobileOpen(false)}
                    className="flex items-center gap-2.5 p-3 rounded-xl bg-bg-secondary/60 border border-line/50 font-bold text-text-primary hover:text-accent-sky"
                  >
                  ...
                  <Link
                    href="/projects/pm-kusum"
                    onClick={() => setMobileOpen(false)}
                    className="flex items-center gap-2.5 p-3 rounded-xl bg-bg-secondary/60 border border-line/50 font-bold text-text-primary hover:text-emerald-500"
                  >
                  ...
                  <Link
                    href="/projects/pm-ssy"
                    onClick={() => setMobileOpen(false)}
                    className="flex items-center gap-2.5 p-3 rounded-xl bg-bg-secondary/60 border border-line/50 font-bold text-text-primary hover:text-amber-500"
                  >
                  ...
                  <Link
                    href="/projects/ipp"
                    onClick={() => setMobileOpen(false)}
                    className="flex items-center gap-2.5 p-3 rounded-xl bg-bg-secondary/60 border border-line/50 font-bold text-text-primary hover:text-accent-gold"
                  >
                  ...
                  <Link
                    href="/projects"
                    onClick={() => setMobileOpen(false)}
                    className="sm:col-span-2 flex items-center justify-center gap-2 p-3 rounded-xl bg-accent-sky/10 border border-accent-sky/30 text-accent-sky font-bold text-xs"
                  >
                    <Layers className="w-3.5 h-3.5 shrink-0" />
                    <span>{t('projectsDropdown.allProjects')}</span>
                  </Link>
            ...
            <div className="rounded-2xl border border-line/80 bg-bg-secondary/40 overflow-hidden transition-all">
              ...
              >
                <div className="flex items-center gap-3">
                  <Briefcase className="w-4.5 h-4.5 text-accent-gold shrink-0" />
              ...
              {mobileCompanyOpen && (
                <div className="p-3 grid grid-cols-1 sm:grid-cols-2 gap-2.5 border-t border-line/60 bg-bg-primary/50 text-xs">
                  <Link
                    href="/vendor-registration"
                    onClick={() => setMobileOpen(false)}
                    className="flex items-center gap-2.5 p-3 rounded-xl bg-bg-secondary/60 border border-line/50 font-bold text-text-primary hover:text-accent-solar"
                  >
            ...
            {/* Mobile Global Translator Card */}
            <button
              type="button"
              onClick={() => {
                setMobileOpen(false);
                window.dispatchEvent(new CustomEvent('open-global-translator'));
              }}
              className="w-full p-4 sm:p-5 rounded-2xl border border-accent-solar/40 bg-accent-solar/10 hover:bg-accent-solar/20 text-accent-solar flex items-center justify-between transition-all shadow-sm group text-left"
            >
              <div className="flex items-center gap-3">
                <div className="w-9 h-9 rounded-xl bg-accent-solar text-white flex items-center justify-center shadow-md shrink-0">
                  <Globe className="w-5 h-5 group-hover:rotate-45 transition-transform duration-300" />
                </div>
                <div>
                  <div className="text-sm font-bold text-text-primary">Translate Website</div>
                  <div className="text-[11px] text-text-secondary font-mono">130+ World Languages Available</div>
                </div>
              </div>
              <Sparkles className="w-4 h-4 text-accent-solar shrink-0" />
            </button>
            ...
            <div className="pt-1">
              <Link
                href="/get-a-quote"
                onClick={() => setMobileOpen(false)}
                className="w-full py-4 rounded-full bg-accent-solar text-white text-xs sm:text-sm font-bold uppercase tracking-wider flex items-center justify-center gap-2 text-center shadow-xl hover:bg-accent-solar/90 active:scale-[0.99] transition-all"
              >
