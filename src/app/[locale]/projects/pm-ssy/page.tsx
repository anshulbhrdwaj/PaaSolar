          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="relative rounded-3xl overflow-hidden border border-amber-500/30 shadow-2xl group">
              ...
              <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between">
                <span className="px-3.5 py-1.5 rounded-full bg-amber-500/90 text-white text-xs font-mono font-bold uppercase tracking-wider backdrop-blur-md shadow-lg flex items-center gap-1.5">
                  <Waves className="w-4 h-4" />
                  <span>Floating Solar Reservoir PV</span>
                </span>
                <span className="text-xs font-mono font-bold text-amber-200 bg-black/60 px-3 py-1 rounded-full backdrop-blur-md border border-amber-500/30">
                  PM-SSY Eligible
                </span>
              </div>
            </div>
