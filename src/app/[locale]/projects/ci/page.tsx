...
import { Building2, CheckCircle2, TrendingDown, DollarSign, ShieldCheck, ArrowRight } from 'lucide-react';
    ...
    <main className="relative min-h-screen bg-bg-primary text-text-primary overflow-x-hidden pt-20">
          ...
          <div className="lg:col-span-5">
            <div className="rounded-3xl p-8 bg-bg-secondary border border-line shadow-2xl space-y-6">
              <div className="flex items-center justify-between border-b border-line pb-4">
                <span className="font-mono text-xs uppercase tracking-widest text-text-secondary">OPEX SAVINGS</span>
      ...
      <section className="py-24 max-w-7xl mx-auto px-6">
        <div className="p-8 rounded-3xl bg-bg-secondary/50 border border-line space-y-6">
          <h3 className="font-serif text-3xl font-bold text-text-primary mb-4">Enterprise C&I Solar Advantages</h3>
